...
class VolumeAttachmentController(wsgi.Controller):
    ...
    def _fixup_bdm(self, instance, bdm):
        if bdm.is_root:
            return

        try:
            self.compute_api.compute_rpcapi.detach_volume(context, instance=instance,
                volume_id=bdm.volume_id, attachment_id='missing-attachment-id')
        except exception.VolumeUnattached:
