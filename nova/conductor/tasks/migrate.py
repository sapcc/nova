...
class MigrationTask(base.TaskBase):
    ...
    def _execute(self):
        ...
        # --- Cross-HV image-backed conversion ---
        # If this is a cross-HV resize, validate the root BDM shape and
        # convert if needed before handing off to the BFV-only path.
        # The conversion is permanent (asymmetric revert: revert undoes
        # the migration but leaves the instance as BFV-on-VMware).
    ...
    def _convert_image_backed_root_to_bfv(self, root_bdm):
        ...
        #    passes rollback data so the wrapper can call
        ...
        # 4. Create a reserved attachment (no connector yet)
        try:
        ...
        # 6. Mutate the root BDM to volume-backed
        try:
            ...
            # Preserve source_type and image_id intentionally
            root_bdm.save()
        except Exception:
        ...
        # 7. Mark conversion in system metadata
