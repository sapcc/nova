...
class VMwareVMOps(object):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        if extra_specs.evc_mode_key:
            evc_mode_key = extra_specs.evc_mode_key
            wanted_evc_mode_sort_key = self._evc_mode_sort_key[evc_mode_key]
            max_evc_mode_sort_key = \
                self._evc_mode_sort_key[self._max_evc_mode_key]
            if wanted_evc_mode_sort_key > max_evc_mode_sort_key:
                evc_mode_key = self._max_evc_mode_key
            vm_util.apply_evc_mode(self._session, vm_ref,
                                   self._evc_modes[evc_mode_key])
    ...
    def _resize_vm(self, context, instance, vm_ref, flavor, image_meta):
        ...
        if extra_specs.evc_mode_key:
            ...
            if wanted_evc_mode_sort_key > max_evc_mode_sort_key:
                evc_mode_key = self._max_evc_mode_key
            evc_mode = self._evc_modes[evc_mode_key]
        else:
            # clear any currently configured EVC mode if the flavor doesn't
            # require one
            evc_mode = None
