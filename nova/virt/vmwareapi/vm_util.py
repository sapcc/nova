...
def relocate_vm_spec(client_factory, service, res_pool=None, datastore=None, host=None,
                     disk_move_type="moveAllDiskBackingsAndAllowSharing", migrate_data=None):
...
def relocate_vm(session, service, vm_ref, res_pool=None, datastore=None, host=None,disk_move_type="moveAllDiskBackingsAndAllowSharing"):
    client_factory = session.vim.client.factory
    rel_spec = relocate_vm_spec(client_factory, service, res_pool, datastore, host, disk_move_type)
