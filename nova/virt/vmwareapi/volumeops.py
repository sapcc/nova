...
class VMwareVolumeOps(object):
    ...
    def fixup_shadow_vms(self, instance, shadow_vms):
        ...
        Cinder cannot move the volumes independently.
        ...
        migration)
        In the latter case, we discard the existing attachment of the
        ...
        for device in vm_util.get_hardware_devices(self._session, vm_ref):
            ...
            try:
                ...
                LOG.exception("Failed to attach volume %s. Device %s",
