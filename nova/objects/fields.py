...
class NotificationAction(BaseNovaEnum):
    ...
    ALL = (UPDATE, EXCEPTION, DELETE, PAUSE, UNPAUSE, RESIZE, VOLUME_SWAP,
           ...
           LIVE_MIGRATION_FORCE_COMPLETE, CONNECT, USAGE, BUILD_INSTANCES,
           MIGRATE_SERVER, REBUILD_SERVER, SELECT_DESTINATIONS, IMAGE_CACHE)
...
class InstanceTaskState(BaseNovaEnum):
    ...
    IN_CLUSTER_VMOTION = 'migrating_in_cluster'
