...
class LegacyValidatingNotifier(object):
    ...
    allowed_legacy_notification_event_types = [
        ...
        'compute.instance.cold_migration.pre.end',
        'compute.instance.cold_migration.pre.start',
        'compute.instance.cold_migration.post.dest.start',
        'compute.instance.cold_migration.post.dest.end',
        'compute.instance.cold_migration._rollback.end',
        'compute.instance.cold_migration._rollback.start',
