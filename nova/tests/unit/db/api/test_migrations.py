...
class NovaMigrationsWalk(
    ...
    def _check_f177f53f978b(self, connection):
        ...
        expected_columns = {'created_at', 'domain_id', 'effect', 'flavor_id',
                            'id', 'project_id', 'updated_at', 'uuid'}
        ...
        expected_unique_constraints = [
            {'uuid'}, {'domain_id', 'project_id', 'flavor_id'}]
        ...
        indexes = [
            set(idx['column_names']) for idx in inspector.get_indexes(
                'flavor_permission_rules')]
        expected_indexes = [{'uuid'}, {'domain_id', 'project_id', 'flavor_id'}]
