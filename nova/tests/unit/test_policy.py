...
"os_compute_api:os-flavor-permission-rules:index:all",
"os_compute_api:os-flavor-permission-rules:index:domain",
"os_compute_api:os-flavor-permission-rules:index:project",
"os_compute_api:os-flavor-permission-rules:show:domain",
"os_compute_api:os-flavor-permission-rules:show:project",
"os_compute_api:os-flavor-permission-rules:create:domain",
"os_compute_api:os-flavor-permission-rules:create:project",
"os_compute_api:os-flavor-permission-rules:delete:domain",
"os_compute_api:os-flavor-permission-rules:delete:project",
"os_compute_api:os-flavor-permission-rules:update:domain",
"os_compute_api:os-flavor-permission-rules:update:project",
